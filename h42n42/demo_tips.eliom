  ...
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.tips4
            ~set_page:
              [a ~service:H42n42_services.settings_service [%i18n Demo.tips5] ()]]
    ]
...
let%shared () =
  H42n42_base.App.register ~service:Demo_services.demo_tips
    ( H42n42_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      H42n42_container.page ~a:[a_class ["os-page-demo-tips"]] myid_o p )
