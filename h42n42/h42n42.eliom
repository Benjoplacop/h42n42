...
let%shared () =
  ...
  H42n42_base.App.register ~service:H42n42_services.settings_service
    (H42n42_page.Opt.connected_page H42n42_handlers.settings_handler)

let%server () =
  Eliom_registration.Ocaml.register
    ~service:H42n42_services.upload_user_avatar_service
    (Os_session.connected_fun H42n42_handlers.upload_user_avatar_handler)
